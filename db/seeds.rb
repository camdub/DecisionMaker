...
p0 = Participant.create!(name: 'Sarah Fonseca',position: 'Laos',hashtag: 'sfonseca',image_name: 'laos.png') 
...
p2 = Participant.create!(name: 'Sarah Hogue',position: 'Uganda',hashtag: 'shogue',image_name: 'uganda.png') 
Rating.create!(event_id: ev.id,participant_id:p2.id,rating_count: 0,total_rating: 0) 
p3 = Participant.create!(name: 'Ana Maria Lebada',position: 'Haiti',hashtag: 'alebada',image_name: 'haiti.png') 
...
p5 = Participant.create!(name: 'Selim Lika',position: 'Cambodia',hashtag: 'slika',image_name: 'cambodia.png') 
...
p16 = Participant.create!(name: 'Justin Ong',position: 'Angola',hashtag: 'jong',image_name: 'angola.png') 
...
p27 = Participant.create!(name: 'Adedana  Ashebir',position: 'Algeria',hashtag: 'aashebir',image_name: 'algeria.png') 
...
p29 = Participant.create!(name: 'Reginald Rex Barrer',position: 'Afghanistan',hashtag: 'rbarrer',image_name: 'afghanistan.png') 
Rating.create!(event_id: ev.id,participant_id:p29.id,rating_count: 0,total_rating: 0) 
p30 = Participant.create!(name: 'Onon Bayasgalan',position: 'The Gambia',hashtag: 'obayasgalan',image_name: 'gambia.png') 
...
p33 = Participant.create!(name: 'Vivienne Caballero',position: 'Belize',hashtag: 'vcaballero',image_name: 'belize.png') 
Rating.create!(event_id: ev.id,participant_id:p33.id,rating_count: 0,total_rating: 0) 
p34 = Participant.create!(name: 'Alana Callagy',position: 'Cyprus',hashtag: 'acallagy',image_name: 'cyprus.png') 
...
p44 = Participant.create!(name: 'Fan Li',position: 'Tuvalu',hashtag: 'fli',image_name: 'tuvalu.png') 
Rating.create!(event_id: ev.id,participant_id:p44.id,rating_count: 0,total_rating: 0) 
p45 = Participant.create!(name: 'Omar Malik',position: 'Maldives',hashtag: 'omalik',image_name: 'maldives.png') 
...
p47 = Participant.create!(name: 'Jose Medinamora',position: 'Papua New Guinea',hashtag: 'jmedinamora',image_name: 'papua_new_guinea.png') 
Rating.create!(event_id: ev.id,participant_id:p47.id,rating_count: 0,total_rating: 0) 
p48 = Participant.create!(name: 'William Miao',position: 'Solomon Islands',hashtag: 'wmiao',image_name: 'solomon_islands.png') 
...
p54 = Participant.create!(name: 'Lizzie Shan',position: 'Nauru',hashtag: 'lshan',image_name: 'nauru.png') 
